...
<html>
    ...
    <body>
        ...
        <!--form-->
        <div class="content">
            <form class="form" action="<c:url value='/admin/medicine'/>" method="post">
                <table border="0">
                    <tr class="error">
                    ...
                    <tr>
                        ...
                        <td><input required type="text" name="name" value="${param.name != null?param.name:''}"/></td>
                    </tr>
                    <tr>
                        <td><label>Enter price:</label></td>
                        <td><input required type="number" name="price" value="${param.price != null?param.price:''}"/></td>
                    </tr>
                    <tr>
                        <td><label>Enter description:</label></td>
                        <td><textarea required class="description" name="description" >${param.description != null?param.description:''}</textarea></td>
                    </tr>
                    <tr>
                        <td><label>Enter quantity in stock:</label></td>
                        <td><input required type="number" name="quantity" value="${param.quantity != null?param.quantity:''}"/></td>
                    </tr>
                </table>
